...
export default function SignIn() {
  ...
  const postAuthData = (email: string, password: string) => {
    
    axios
      .post(SIGN_IN_URL, { email, password }, {withCredentials: true})
      .then((res) => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (data) {
      postAuthData(data.get("email") as string, data.get("password") as string);
    }
    // console.log({
