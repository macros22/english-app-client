...
export interface IWordFormMeaning
  extends Required<
    Omit<IMeaning, 'translations' | 'synonyms' | 'antonyms' | 'usageExamples'>
  > {
...
export interface IWordFormValues
  extends Required<Omit<IUserWordPayload, 'meanings' | 'normalizedWord'>> {
